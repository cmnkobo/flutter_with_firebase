...
void main() {
  group('Mock Authentication', () {
    final provider = MockAuthProviders();
    ...
    test(
      'Should be able to initialize in less than 2 secons',
      () async {
        await provider.initialize();
        expect(provider.isInitialized, true);
      },
    ...
    test('Create user should delegate to login', () async {
      ...
      expect(badPasswordUser,
          throwsA(const TypeMatcher<WrongPasswordAuthExcception>()));
...
class MockAuthProviders implements AuthProviders {
  AuthUser? _user;
  ...
  Future<AuthUser> logIn({
    ...
    if (password == 'foobar') throw WrongPasswordAuthExcception();
